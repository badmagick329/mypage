...
export default function OldProjectCard({
  ...
  return (
    <article className="bg-background-light shadow-card @container flex w-full flex-col items-start gap-4 rounded-md">
      <section className="bg-background-lighter/60 relative w-full rounded-t-md py-4 text-center">
